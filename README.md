...
[실제 홈페이지 바로가기](https://smallwaxing.com)

![Small Waxing 홈페이지 메인 화면](docs/main.png)

예제왁싱 매장의 서비스와 가격을 소개하고, 예약 채널과 고객 커뮤니티를 제공하는 웹사이트입니다.
...
| 구분 | 기술 |
| --- |-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Backend | ![Java](https://img.shields.io/badge/Java-21-F5A623?style=flat-square&logo=openjdk&logoColor=black&labelColor=F5A623) ![Spring Boot](https://img.shields.io/badge/Spring_Boot-4.1.0-9BD36A?style=flat-square&logo=springboot&logoColor=black&labelColor=9BD36A) ![Spring Security](https://img.shields.io/badge/Spring_Security-6DB33F?style=flat-square&logo=springsecurity&logoColor=white) |
| View | ![Thymeleaf](https://img.shields.io/badge/Thymeleaf-3-79C982?style=flat-square&logo=thymeleaf&logoColor=black&labelColor=79C982) ![HTML5](https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white) ![CSS3](https://img.shields.io/badge/CSS3-1572B6?style=flat-square&logo=css3&logoColor=white) ![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black) |
| Database | ![MySQL](https://img.shields.io/badge/MySQL-8.4-72C5E8?style=flat-square&logo=mysql&logoColor=black&labelColor=72C5E8) |
...
| Server | ![AWS Lightsail](https://img.shields.io/badge/AWS_Lightsail-232F3E?style=flat-square&logo=amazonlightsail&logoColor=white) |
...
![Small Waxing 시스템 아키텍처](docs/system-architecture1.png)
